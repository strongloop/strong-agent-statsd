...
Thank you for your interest in `strong-agent-statsd`, an open source project
administered by StrongLoop.

Contributing to `strong-agent-statsd` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-agent-statsd)
